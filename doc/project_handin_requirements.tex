...
Rapporten skal overholde retningslinjer og krav i “Kontrolskema for Rapport” (se afsnit \ref{sec:control}). Rapporten må ikke overstige 40 sider (uden bilag). Den skal dække ovenstående indhold fyldestgørende. Det vil nok kræve omkring 35 sider.
