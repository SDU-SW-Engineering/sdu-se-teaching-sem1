...
Ved afslutningen af iteration \#1 afleveres java-projektet (se afsnit \ref{sec:code} herunder) i sin foreløbige form og et udkast til projektporteføljen (se afsnit \ref{sec:report} herunder).
...
Ved afslutningen af projektet afleveres det endelige java-projekt og den endelige projektportefølje. Java-projektet og projektporteføljen bruges som grundlag for jeres forberedelse til den mundtlige projekteksamen. 

\section{Java Projekt}
\label{sec:code}

Java-projektet afleveres som en zip-fil. Øvrige krav til java-projektet fremgår af projektbeskrivelsen (se på itslearning under Planer/Semesterprojekt og Projektbeskrivelse).
...
Projektporteføljen skal overholde retningslinjer og krav i “Kontrolskema for projektportefølje” (se afsnit \ref{sec:control}).
...
\begin{longtable}{|l|p{.6\textwidth}|c|}
  ...
  \hline
    \textbf{Krav}
    &
    De samlede krav (modtagne og formuleret af jer). Analyse af kravene.
    &
    \\
  \hline
    \textbf{Design}
