...
filename = "tables/project_phase3_programudvikling.tex"
headercolor = "blue!25"
window = {
  "begin": datetime.strptime("2024 October 6", "%Y %B %d"),
  "end":   datetime.strptime("2024 December 15", "%Y %B %d"),
}
...
def filter_function (entry):
  ...
  if entry["key"]=="Universitet": return True
  if entry["key"]=="ProOnline": return True
  if entry["key"]=="Projekt": return True
