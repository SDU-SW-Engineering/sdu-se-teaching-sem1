...
\begin{frame}[fragile]
  ...
  \scalebox{0.82}{
    \begin{tikzpicture}[remember picture, overlay]
      ...
      \node[hold, anchor=north] (se) at ([yshift=-\ydist] semester.south) {SE};
      \node[hold, anchor=east] (st) at ([xshift=-\holddist] se.west) {ST};
      \node[hold, anchor=west, draw=gray, text=gray] (spiltek) at ([xshift=\holddist] se.east) {SpilTek};
      ...
      \node[descriptor] (desc hold)     at (spiltek-|labels)  {\textsl{Hold}};
      ...
      \draw[->, edge, draw=blue] (desc hold)     -- ([xshift=6mm] spiltek.east);
