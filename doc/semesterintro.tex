...
\begin{frame}
  \vspace{4mm}
  \begin{center}
    \qrcode[height=5cm]{https://PollEv.com/surveys/d3R8eGC5U1c1fmXcGTF1c/respond}
...
\begin{frame}[fragile]
  ...
  \scalebox{0.72}{
    \begin{tikzpicture}[remember picture, overlay]
      ...
      \newcommand{\cosXsune}[0]{(\cosX+\spacing+\imgsize/2)}
      ...
      \draw[gridline] ({\cosXsune},{\classIy})   -- ({\cosXsune},{\belowY});
...
%      \node[onlyteach] () at ({\proXsuperIV} ,{\classVy}) {};
      ...
      \node[teachexam] () at ({\cosXsune},{\classIy}) {};
      \node[teachexam] () at ({\cosXsune},{\classIIy}) {};
      \node[teachexam] () at ({\cosXsune},{\classIIIy}) {};
      \node[teachexam] () at ({\cosXsune},{\classIVy}) {};
      \node[teachexam] () at ({\cosXsune},{\classVy}) {};
      ...
      % supervisors
      \node[anchor=north] (superI)   at ({\proXsuperI}  ,{\belowY}) {\rotatebox{90}{Grzegorz}};
      \node[anchor=north] (superII)  at ({\proXsuperII} ,{\belowY}) {\rotatebox{90}{Henrik}};
      \node[anchor=north] (superIII) at ({\proXsuperIII},{\belowY}) {\rotatebox{90}{Henrik}};
      \node[anchor=north] (superIV)  at ({\proXsuperIV} ,{\belowY}) {\rotatebox{90}{Jeppe}};
      \node[anchor=north] (superV)   at ({\proXsuperV}  ,{\belowY}) {\rotatebox{90}{Rune}};
      ...
      \personSouth{{\cosXsune},{\belowY}}{Sune}{figs/people/sune_lundoe_soerensen.jpeg}
...
%  \vspace{30mm}
%  \begin{center}
%    Husk at gennemføre studiestartprøven \quoted{How to Uni} før deadline (September 8, 2024)
%  \end{center}
%\end{frame}
