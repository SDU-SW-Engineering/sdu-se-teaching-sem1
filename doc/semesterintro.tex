...
\begin{frame}[fragile]
  ...
  \scalebox{0.82}{
    \begin{tikzpicture}[remember picture, overlay]
      ...
      \newcommand{\classIIIy}[0]{(\classIIy-\spacing)}
      \newcommand{\classIVy}[0]{(\classIIIy-3*\spacing)}
      \newcommand{\classVy}[0]{(\classIVy-\spacing)}
      \newcommand{\belowY}[0]{(\classIVy-2*\spacing)}
      ...
      \node[education] (eduST) at ([yshift=0] classIV.north) {\textbf{ST}};
      ...
      \node[anchor=north] (superV)   at ({\proXsuperV}  ,{\belowY}) {\rotatebox{90}{Vejleder 4}};
...
\begin{frame}[fragile]
  ...
  \end{center}
  \begin{tikzpicture}[remember picture, overlay]
    \node[rectangle, rounded corners, draw=red, very thick, minimum width=31mm, minimum height=31mm] (highlight) at (86.4mm,22.4mm) {};
  \end{tikzpicture}
\end{frame}
