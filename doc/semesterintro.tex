...
\begin{frame}[fragile]
  ...
  \begin{tikzpicture}[remember picture, overlay]
    ...
    % schedule
    \node[lecture]  () at (monday10) {\textbf{OOP} \\ \scriptsize Forelæsning i U1};
    \node[exercise] () at (monday12) {\textbf{OOP} \\ \scriptsize Øvelser};
    \node[project]  () at (tuesday08) {\textbf{Project}};
    \node[lecture]  () at (wednesday12) {\textbf{OOP} \\ \scriptsize Forelæsning i U1};
    \node[exercise] () at (wednesday14) {\textbf{OOP} \\ \scriptsize Øvelser};
    \node[lecture]  () at (thursday12) {\textbf{SDA} \\ \scriptsize Forelæsning i U1};
