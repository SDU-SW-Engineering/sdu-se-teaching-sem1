...
\begin{itemize}
\item Under Oversigt (Announcements) ligger alle meddelelser om kurset, så du til enhver tid kan se både gamle og nye meddelelser. Du får oplysninger om kursusplan og kontaktpersoner som en annoncering.
\item Under Planer ligger kursets moduler, som beskriver alt det du løbende skal gøre i kurset.

\item Under Ressourcer finder du alle de materialer som bruges i kursets moduler. Under ressourcers kan du altså genfinde kursusmaterialer.

\item Under Status og opfølgning kan du se dine fremskridt på kurset.
\end{itemize}
