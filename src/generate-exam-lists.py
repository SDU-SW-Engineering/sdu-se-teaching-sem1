...
generate_oop_schedules("SDU SE OOP 2022 - Eksamensplan.xlsx", show_censors=False, show_grades=False)
generate_oop_schedules("SDU SE OOP 2022 - Eksamensplan Partiel.xlsx", show_censors=True, show_grades=False)
generate_oop_schedules("SDU SE OOP 2022 - Eksamensplan Full.xlsx", show_censors=True, show_grades=True)
